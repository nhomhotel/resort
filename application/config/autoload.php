...
*/
$autoload['helper'] = array('form', 'security', 'url', 'text', 'constants','table','config_email','mystring','language','slide_show');
...
*/
$autoload['model'] = array('App_config_model','User_model','Follow_Social_model','area_model');
