        ...
        <fieldset>
            <div class="widget">
                ...
                <div class="formSubmit">
                    ...
                    <input type="button" value="Hủy bỏ" class="basic" onclick="if (confirm('Bạn có muốn hủy cập nhật và quay lại trang danh sách?')) {
                                window.location = '<?php echo admin_url('experience/index'); ?>'
                            }" />
                </div>
                <div class="clear"></div>
            </div>
