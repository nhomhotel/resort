            ...
            <div class="widget">
                ...
                <div class="tab_container tab-content">
                    <div id='tab1' class="tab_content pd0 tab-pane active" role="tabpanel">
                        <div class="formRow">
                            <label class="formLeft" for="param_name">Tên mạng:<span class="req">*</span></label>
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input type="text" name="name_network" id="param_name" _autocheck="true" value="<?php echo!(set_value('name_network')) ? ($info->name) : (set_value('name_network')); ?>" />
                                </span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input type="text" class="form-control" id="usr" name="link_network" value="<?php echo!(set_value('link__network')) ? ($info->link) : (set_value('link__network')); ?>">
                                </span>
                            </div>
                            <div class="clear"></div>
                        </div>	
                ...
                <div class="formSubmit">
                    ...
                    <input type="reset" onclick="if (confirm('Bạn muốn hủy cập nhật và quay lại trang danh sách')) {
                                window.location = '<?php echo admin_url('FollowSocial'); ?>';
