                ...
                <div class="tab_container tab-content">
                    <div id='tab1' class="tab_content pd0 tab-pane active" role="tabpanel">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                   <textarea name="News_category_title"  _autocheck="true" ><?php echo!(set_value('News_category_title')) ? ($info->title) : (set_value('News_category_title')); ?></textarea>
                                </span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <textarea name="News_category_title_en"  _autocheck="true" ><?php echo!(set_value('News_category_title_en')) ? ($info->title_en) : (set_value('News_title_en')); ?></textarea>
                                </span>
                                <span name="name_autocheck" class="autocheck"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                   <textarea name="News_category_description"  _autocheck="true" ><?php echo!(set_value('News_category_description')) ? ($info->description) : (set_value('News_category_description')); ?></textarea>
                                </span>
                                <span name="name_autocheck" class="autocheck"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <textarea name="News_category_description_en"  _autocheck="true" ><?php echo!(set_value('News_category_description_en')) ? ($info->description_en) : (set_value('News_category_name_en')); ?></textarea>
                                </span>
                                <span name="name_autocheck" class="autocheck"></span>
                                <div name="name_error" class="clear error"><?php echo form_error('News_category_description_en'); ?></div>
                            </div>
