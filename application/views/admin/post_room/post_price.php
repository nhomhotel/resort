                                    ...
                                    <div class="formRight">
                                        <div class="left">
                                            <label for="name">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['price_night_vn'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->price_night_vn;
                                                else
                                                    echo set_value('price_night_vn');
...
//                                                                                                echo (isset($post_price))?$post_price['price_night_vn']: set_value('price_night_vn') ;
                                            ...
                                            <label for="name">
                                                ...
                                                <input type="text" class="required digits mw150" id="price_night_en" name="price_night_en" value="<?php
                                                       if (isset($post_price))
                                                           echo $post_price['price_night_en'];
                                                       elseif (isset($data_post_room))
                                                           echo $data_post_room->price_night_en;
                                                       else
                                                           echo set_value('price_night_en');
                                    ...
                                    <div class="formRight">
                                        <div class="left">
                                            <label for="">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['price_lastweek_vn'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->price_lastweek_vn;
                                                else
                                                    echo set_value('price_lastweek_vn');
//                                                                                                echo (isset($post_price))?$post_price['price_lastweek_vn']: set_value('price_lastweek_vn') ;
                                            ...
                                            <label for="">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['price_lastweek_en'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->price_lastweek_en;
                                                else
                                                    echo set_value('price_lastweek_en');
...
if (isset($post_price))
    echo $post_price['price_week_vn'];
elseif (isset($data_post_room))
    echo $data_post_room->price_week_vn;
else
    echo set_value('price_week_vn');
...
?>">
                                            ...
                                            <label for="name">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['price_week_en'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->price_week_en;
                                                else
                                                    echo set_value('price_week_en');
                                    ...
                                    <div class="formRight">
                                        <div class="left">
                                            <label for="">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['price_month_vn'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->price_month_vn;
                                                else
                                                    echo set_value('price_month_vn');
//                                                                                                echo (isset($post_price))?$post_price['price_month_vn']:set_value('price_month_vn');
                                            ...
                                            <label for="">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['price_month_en'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->price_month_en;
                                                else
                                                    echo set_value('price_month_en');
                                    ...
                                    <div class="formRight">
                                        <div class="left">
                                            <label for="name">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['deposit_vn'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->deposit_vn;
                                                else
                                                    echo set_value('deposit_vn');
//                                                                                                echo (isset($post_price))?$post_price['deposit_vn']:set_value('deposit_vn');
                                            ...
                                            <label for="name">
                                                ...
                                                if (isset($post_price))
                                                    echo $post_price['deposit_en'];
                                                elseif (isset($data_post_room))
                                                    echo $data_post_room->deposit_en;
                                                else
                                                    echo set_value('deposit_en');
                                ...
                                <div class="formRow">
                                    ...
                                    <div class="formRight">
                                        <div class="left clearfix">
                                            ...
                                            if (isset($post_price))
                                                echo $post_price['price_guest_more_vn'];
                                            elseif (isset($data_post_room))
                                                echo $data_post_room->price_guest_more_vn;
                                            else
                                                echo set_value('price_guest_more_vn');
//                                                                                                echo (isset($post_price))?$post_price['price_guest_more_vn']:set_value('price_guest_more_vn');
                                            ...
                                            if (isset($post_price))
                                                echo $post_price['price_guest_more_en'];
                                            elseif (isset($data_post_room))
                                                echo $data_post_room->price_guest_more_en;
                                            else
                                                echo set_value('price_guest_more_en');
...
elseif (isset($data_post_room))
    ...
    echo set_value('regulations');?></textarea>
                ...
                <div class="formSubmit">
                    <div class="prev-step">
                        <a href="<?php if (isset($data_post_room))
    echo admin_url('post_room/edit/' . $id);
else
    echo admin_url('post_room/post');
?>" class="btn btn-default redB"><< Quay lại</a>
                    </div>
                    <div class="next-tep"> 
