...
<div class="titleArea clearfix">
    <div class="wrapper col-md-12">
        ...
        <div class="horControlB menu_action">
            <ul>
                <li>
                    <a href="<?php echo base_url('admin/IntroSlider/create'); ?>">
        ...
        <div class="table-responsive">
            <table class="table sTable mTable myTable" id="checkAll">
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="list_action itemActions">
                                <a href="javascript:void(0)" onclick = "deleteAll()" id="submit" class="button blueB" url="<?php echo admin_url('IntroSlider/deleteAll'); ?>">
                ...
                <tbody class="list_item">
                    ...
                    foreach ($list as $row) {
                        ?>
                        <tr class='row_<?php echo $row->intro_slider_id; ?>'>
                            <td class="textC">
                                <input type="checkbox" name="id[]" value="<?php echo $row->intro_slider_id; ?>" />
                            </td>
                            ...
                            <td class="textC">
                                ...
                                <?php
                                    if ($row->view_home == 1) {
                                        ?>
                                        <a href="javascript:void(0)" onclick="status(<?php echo $row->intro_slider_id; ?>)" class="lightbox" title="block">
                                            <img src="<?php echo base_url(); ?>public/admin/images/icons/color/tick.png" />
                                        </a>
                                        <?php
                                    } else {
                                        ?>
                                        <a href="javascript:void(0)" onclick="status(<?php echo $row->intro_slider_id; ?>)" class="lightbox" title="active">
                            ...
                            <td class="textC">
                                <a href="<?php echo base_url('admin/IntroSlider/edit/' . $row->intro_slider_id); ?>" class="lightbox" title="edit">
                                    <img src="<?php echo base_url(); ?>public/admin/images/icons/color/pencil.png" />
                                </a>
                                &nbsp;
                                <a href="<?php echo base_url('admin/IntroSlider/delete/' . $row->intro_slider_id); ?>" class="lightbox" title="delete" onclick="return confirm('Bạn có muốn xóa?');">
...
<script type="text/javascript">
    ...
    function status(id) {
        ...
        $.ajax({
            url: admin_url + '/IntroSlider/status',
            type: "post",
            dataType: "text",
            data: {
                'id': id,
