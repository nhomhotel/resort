<div class="titleArea clearfix">
    <div class="wrapper clearfix col-md-12">
        ...
        <div class="horControlB menu_action">
            <ul>
                <li>
                    <a href="<?php echo base_url('admin/IntroSlider'); ?>">
            ...
            <div class="widget">
                ...
                <div class="tab_container tab-content">
                    <div id='tab1' class="tab_content pd0 tab-pane active" role="tabpanel">
                        <div class="formRow">
                            <label class="formLeft" for="image_intro_slider">Hình ảnh:</label>
                            <div class="formRight">
                                <input type="file" name="image_intro_slider"/>
                                <span name="name_autocheck" class="autocheck"></span>
                                <div name="image_intro_slider" class="clear error"><?php echo form_error('image_intro_slider'); ?></div>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="formRow">
                            <label class="formLeft" for="link_intro_slider">Link :</label>
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input type="text" class="form-control" id="usr" name="link_intro_slider">
                                </span>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="formRow">
                            <label class="formLeft" for="view_intro_slider">hiển thị trên web:</label>
                            <div class="formRight">
