<div class="titleArea clearfix">
    <div class="wrapper clearfix col-md-12">
        ...
        <div class="horControlB menu_action">
            <ul>
                <li>
                    <a href="<?php echo base_url('admin/helps/tag'); ?>">
            ...
            <div class="widget">
                ...
                <div class="tab_container tab-content">
                    <div id='tab1' class="tab_content pd0 tab-pane active" role="tabpanel">
                        <div class="formRow">
                            <label class="formLeft" for="param_name">Tên tags:<span class="req">*</span></label>
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input type="text" name="nameTag" id="param_name" _autocheck="true" value="<?php echo set_value('nameTag'); ?>" />
                                </span>
