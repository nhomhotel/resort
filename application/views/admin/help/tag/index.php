...
<div class="titleArea clearfix">
    <div class="wrapper col-md-12">
        ...
        <div class="horControlB menu_action">
            <ul>
                <li>
                    <a href="<?php echo base_url('admin/helps/createTag'); ?>">
        ...
        <div class="table-responsive">
            <table class="table sTable mTable myTable" id="checkAll">
                    ...
                    <tr>
                        <td colspan="9">
                            <div class="list_action itemActions">
                                <a href="javascript:void(0)" onclick = "deleteAll()" id="submit" class="button blueB" url="<?php echo admin_url('helps/deleteListTag'); ?>">
                ...
                <tbody class="list_item">
                    ...
                    foreach ($list as $row) {
                        ?>
                        <tr class='row_<?php echo $row->tag_id; ?>'>
                            <td class="textC">
                                <input type="checkbox" name="id[]" value="<?php echo $row->tag_id; ?>" />
                            </td>
                            ...
                            <td class="textC">
                                <a href="<?php echo base_url('admin/helps/editTag/' . $row->tag_id); ?>" class="lightbox" title="edit">
                                    <img src="<?php echo base_url(); ?>public/admin/images/icons/color/pencil.png" />
                                </a>
                                &nbsp;
                                <a href="<?php echo base_url('admin/helps/deleteTag/' . $row->tag_id); ?>" class="lightbox" title="delete" onclick="return confirm('Bạn có muốn xóa?');">
