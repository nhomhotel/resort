...
<div class="titleArea clearfix">
    <div class="wrapper col-md-12">
        ...
        <div class="horControlB menu_action">
            <ul>
                <li>
                    <a href="<?php echo base_url('admin/helps/createTopic'); ?>">
        ...
        <div class="table-responsive">
            <table class="table sTable mTable myTable" id="checkAll">
                ...
                <tbody class="list_item">
                    ...
                    foreach ($list as $row) {
                        ?>
                        <tr class='row_<?php echo $row->topic_id; ?>'>
                            <td class="textC">
                                <input type="checkbox" name="id[]" value="<?php echo $row->topic_id; ?>" />
                            </td>
                            ...
                            <td class="textC">
                                <a href="<?php echo base_url('admin/helps/editTopic/' . $row->topic_id); ?>" class="lightbox" title="edit">
                                    <img src="<?php echo base_url(); ?>public/admin/images/icons/color/pencil.png" />
                                </a>
                                &nbsp;
                                <a href="<?php echo base_url('admin/helps/deleteTopic/' . $row->topic_id); ?>" class="lightbox" title="delete" onclick="return confirm('Bạn có muốn xóa?');">
...
<script type="text/javascript">
    ...
    function status(id) {
        ...
        $.ajax({
            url: admin_url + '/helps/statusTopic',
            type: "post",
            dataType: "text",
            data: {
                'id': id,
