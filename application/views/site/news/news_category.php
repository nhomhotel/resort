        ...
        <?php foreach ($newsCategory as $line => $row): ?>
            ...
            <?php else: ?>
                ...
                <div class="coloumn-2 inline">
                    <a class="white-container" href="<?php echo NewsUrl($row->description,$row->news_category_id)?>" target="_blank">
                        <div class="press-sprite img-presss-17" style="width: 200px;height: 40px;margin: 0 auto;background: url('<?php echo !empty($row->image)?$row->image:''?>') no-repeat scroll center center / cover"></div>
