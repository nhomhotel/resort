...
//                                                alert("error handler!");                        
        ...
        <div class="col-md-2 col-sm-3 col-xs-6">
            <input type="text" name="checkin" value="<?php echo isset($checkin)&& validateDate($checkin)?$checkin:''?>" id="checkin" class="form-control input-lg form-control-icon icon-calendar hasDatepicker" placeholder="<?php echo lang('home_checkin');?>"/>
        </div>
        <div class="col-md-2 col-sm-3 col-xs-6">
